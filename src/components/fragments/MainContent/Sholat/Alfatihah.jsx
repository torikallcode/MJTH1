        ...
        <div className="overflow-x-auto">
          <div className="w-full mx-auto xl:max-w-6xl">
            <div className='mb-3'>
              ...
              <p className='text-base font-poppins'>Melafadzkan niat itu sunnah ,yang tujuannya untuk menguatkan niat. Sedangkan yang wajib itu melintaskan niat ke dalam hati, pada Mazhab Syafii Niat berada di dalam takbiratul ihram.
